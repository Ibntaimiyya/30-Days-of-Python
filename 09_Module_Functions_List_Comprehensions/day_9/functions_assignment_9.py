def add_two_numbers(num1, num2):
    total = num1 + num2
    return total
print("The sum is:", add_two_numbers(5,6))
...
def add_all_nums (*nums):
    ...
    for num in nums:
        total += num
    return total
print('The sum of all numbers is:', add_all_nums (4, 2, 9, 0, 2, 5, 7))
...
print('The temperature is', _convert_celsius_to_fahrenheit_(30),'F' )


month = int(input('Enter a month:'))
def _check_season (month):
...
print("The season is ", _check_season(month))
...
def is_unique(list):
    if len(list) == len(set(list)):
        ...
        return False
print(is_unique([1,2,3,4,5,7]))
print(is_unique([1,2,3,4,5,5,7]))
...
def is_same_data_type(list):
    for i in list:
        if type (i) == type(list[0]):
            ...
            return False
print(is_same_data_type([1, 2, 3, 4,5,6,7]))
...
def is_valid_python_variable(variable):
    if variable.isidentifier():
        ...
        return False
print(is_valid_python_variable('first_name'))
print(is_valid_python_variable('3first_name'))
...
for language, count in top_20_languages:print(f"{language}: {count}")
...
for country in top_10_populated_countries:print(f"{country['name']}: {country['population']}")
